...
type handlersEpisode struct {
	EpisodeRepository repositories.EpisodeRepository
}

func HandlerEpisode(EpisodeRepository repositories.EpisodeRepository) *handlersEpisode {
	return &handlersEpisode{EpisodeRepository}
}

func (h *handlersEpisode) FindEpisode(w http.ResponseWriter, r *http.Request) {
...
func (h *handlersEpisode) GetEpisode(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
...
func (h *handlersEpisode) CreateEpisode(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")

	var request models.Episode
...
func (h *handlersEpisode) UpdateEpisode(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
...
func (h *handlersEpisode) DeleteEpisode(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
...
// func convertResponseEpisode(e models.Episode) models.Episode {
